...
class IMUBase:
    ...
    def allan_coefs(self, sensor, taus):
        ...
        Allan variance described in:

          Jurado, J, Schubert Kabban, CM, Raquet, J (2019).  A
          regression-based methodology to improve estimation of inertial
          sensor errors using Allan variance data. Navigation 66:251-263.
