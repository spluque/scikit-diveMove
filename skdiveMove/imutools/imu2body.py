...
class IMU2Body(IMUBase):
    ...
    In addition to attributes in `IMUBase`.
    ...
    def from_csv_nc(cls, surface_details_csv, imu_nc, endasc_col=0,
        ...
        load_dataset_kwargs : dict, optional
            ...
            `xarray.load_dataset`.
        **kwargs : optional keyword arguments
            Additional arguments passed to `IMUBase.__init__` method,
    ...
    def orient_surfacings(self, R_all=None):
        ...
        "smooth" transition between segments.  Use `orient_IMU` once
        satisfied with the results from individual segments to achieve a
        smooth adjustment of orientation across segments.
