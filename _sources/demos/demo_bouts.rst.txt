...
Create a :class:`~skdiveMove.TDR` object to easily calculate the necessary
statistics:
...
`skdiveMove` provides the :class:`bouts.BoutsNLS` class for fitting
